...
base_command = (
    "python evaluate_temporal_localization_multi_param.py --model_type {model_type} --pretrained_path {pretrained_path} --dataset {dataset_type} "
    "--src_modality {src_modality} --tgt_modality {tgt_modality} "
    "--n_frames 24 --embed_dim 512"
)
